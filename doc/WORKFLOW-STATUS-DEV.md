...
> 维护者：AI 助手| 最后更新：2026-06-08T11:30
> 
...
| 日期 | 任务 | 状态 | 备注 |
|------|------|------|------|
| 2026-06-08 | 修复局域网登录 Web Cryptography 报错并支持 HTTPS | ✅ 完成 (已推dev) | 安装并引入 @vitejs/plugin-basic-ssl 开启自签名 HTTPS，提供局域网下的安全上下文以支持 window.crypto.subtle；新增 /api 反向代理，将 API_BASE 设为相对路径以避免 Mixed Content 跨域阻断，并在加密服务中添加对 subtle 的安全校验。 |
...
| 日期 | 文档 | 变更摘要 |
|------|------|----------|
| 2026-06-08 | `WORKFLOW-STATUS-DEV.md` | 看板同步：新增解决局域网登录 Web Cryptography 报错问题的修复记录。 |
