...
> **这是一份实用参考指南**。当遇到需要调试的 Bug 时，**必须按照**本指南构建反馈循环。本项目标准的调试流程由外部 Superpowers 技能 `systematic-debugging` 约束，但本指南提供了具体的构建工具。
...
清理规范：参照 [WORKFLOW.md](../rules/WORKFLOW.md) §三.2 强制清理红线。
